...
public class EnemigoB extends Enemigo {
    ...
    private static Animacion animacionFlota(int skin){
        ...
        fotograma.add(new Sprite("imagenes/Space Invaders/Invaders/space__0003_B2.png"));
         ...
         fotograma.add(new Sprite("imagenes/Space Invaders/Invaders/Invaders_nuevo/Invasor2_A10.png"));
         fotograma.add(new Sprite("imagenes/Space Invaders/Invaders/Invaders_nuevo/Invasor2_A20.png"));   
        }
